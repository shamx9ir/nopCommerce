...
namespace Nop.Data.Migrations
{
    ...
    [Migration("20200108223028_BatchFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.Batch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.BatchComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.Component", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.ProductComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Nop.Core.Domain.Catalog.BatchComponent", b =>
                {
                    b.HasOne("Nop.Core.Domain.Catalog.Batch", "Batch")
                        .WithMany("BatchComponents")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Nop.Core.Domain.Catalog.Component", "Component")
                        .WithMany()
